...
1. **只读**：E 用户输入 + E-questions-round*-resolved + R / A / P / D / L / X / S / I / N / H / V 全部冻结产物 + `A00-01` + `A00-03` + `A00-04` + 本模板。
...
> **阶段**：E · 产品经理
> **上游依赖**：docs/C05-prd/<feature-id>/_input/prd-context.md，以及 R / A / P / D / L / X / S / I / N / H / V 全部冻结产物
> **冻结状态**：未冻结
...
> 仅给"表名 + 一句职责 + 关键关系"。字段详情请回查 docs/D01-data/<feature-id>/。
...
> 仅给"endpoint + 方法 + 一句职责"。请求 / 响应字段请回查 docs/D02-api/<feature-id>/。

| 模块 | endpoint | 方法 | 一句职责 | 角色 | 详情链接 |
|-----|---------|------|---------|------|---------|
| M-001 | /api/... | GET | | | docs/D02-api/<f>/02-endpoints/get-xxx.md |
```
