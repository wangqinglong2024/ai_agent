...
```
我已答完 S 澄清。请按 /prompt/F04-S03-AI输出-设计系统.md 多文件结构输出，
落盘到 docs/F04-design-system/。
...
```markdown
<!-- TARGET-PATH: docs/F04-design-system/00-index.md -->
...
```markdown
<!-- TARGET-PATH: docs/F04-design-system/01-tokens.md -->
...
```markdown
<!-- TARGET-PATH: docs/F04-design-system/02-layout.md -->
...
```markdown
<!-- TARGET-PATH: docs/F04-design-system/03-navigation.md -->
...
```markdown
<!-- TARGET-PATH: docs/F04-design-system/04-status-colors.md -->
...
```markdown
<!-- TARGET-PATH: docs/F04-design-system/05-components/<file>.md -->
...
```markdown
<!-- TARGET-PATH: docs/F04-design-system/06-interactions.md -->
...
```markdown
<!-- TARGET-PATH: docs/F04-design-system/07-responsive-dark.md -->
...
```markdown
<!-- TARGET-PATH: docs/F04-design-system/99-open-questions.md -->
