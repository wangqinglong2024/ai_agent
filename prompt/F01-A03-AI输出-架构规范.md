...
> **阶段**：A 技术架构
> **谁产出**：AI（架构师）
> **落盘**：`docs/F01-architecture/` 下多个文件（见 `04-文档目录规划`）
...
```
我已答完 A 澄清。请按 /prompt/F01-A03-AI输出-架构规范.md 的多文件结构输出，
落盘到 docs/F01-architecture/ 下对应文件，并在 00-index.md 中索引。
单文件 ≤ 1200 行，超出按主题继续拆。
...
```markdown
<!-- TARGET-PATH: docs/F01-architecture/00-index.md -->

# 架构与技术规范 · 索引

> **阶段**：A · 架构师
> **上游依赖**：docs/C01-requirements/<feature-id>/baseline.md, docs/F01-architecture/_input/preferences.md, A-questions-resolved
> **冻结状态**：未冻结
...
```markdown
<!-- TARGET-PATH: docs/F01-architecture/01-tech-stack.md -->
...
```markdown
<!-- TARGET-PATH: docs/F01-architecture/02-project-structure.md -->
...
```markdown
<!-- TARGET-PATH: docs/F01-architecture/03-database.md -->
...
```markdown
<!-- TARGET-PATH: docs/F01-architecture/04-api-conventions.md -->
...
```markdown
<!-- TARGET-PATH: docs/F01-architecture/05-coding-standards.md -->
...
```markdown
<!-- TARGET-PATH: docs/F01-architecture/06-deploy-env.md -->
...
```markdown
<!-- TARGET-PATH: docs/F01-architecture/07-i18n-responsive.md -->
...
```markdown
<!-- TARGET-PATH: docs/F01-architecture/99-open-questions.md -->
