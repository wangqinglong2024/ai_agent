...
```
我已答完 L 澄清。请按 /prompt/C07-L03-AI输出-接口规范.md 多文件结构输出，
落盘到 docs/C07-api/<feature-id>/。
路径/响应/错误码必须遵守 F01 04-api-conventions。
...
```markdown
<!-- TARGET-PATH: docs/C07-api/<feature-id>/00-index.md -->

# 接口规范 · <feature-id> · 索引

> **阶段**：L · 接口设计师
> **关联 R-ID**：R-XXX
> **上游**：F01 04-api-conventions, F02, 本 feature C03 页面交互, C06 D-<feature-id>, L-<feature-id>-questions-resolved
...
```markdown
<!-- TARGET-PATH: docs/C07-api/<feature-id>/01-overview.md -->
...
```markdown
<!-- TARGET-PATH: docs/C07-api/<feature-id>/02-endpoints/<method>-<path>.md -->
...
```markdown
<!-- TARGET-PATH: docs/C07-api/<feature-id>/03-error-codes.md -->

# 错误码（feature 内）

> 全局段位见 F01 04-api-conventions。本表只列本 feature 占用的具体码。
...
```markdown
<!-- TARGET-PATH: docs/C07-api/<feature-id>/04-events.md -->
...
```markdown
<!-- TARGET-PATH: docs/C07-api/<feature-id>/99-open-questions.md -->
