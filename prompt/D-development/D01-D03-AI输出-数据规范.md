...
```
我已答完 D 澄清。请按 /prompt/C06-D03-AI输出-数据规范.md 多文件结构输出，
落盘到 docs/C06-data/<feature-id>/。
所有命名/通用字段/主键策略必须遵守 F01 03-database。
不重定义 F02 04-user-data-model 中的认证表。
...
```markdown
<!-- TARGET-PATH: docs/C06-data/<feature-id>/00-index.md -->

# 数据模型 · <feature-id> · 索引

> **阶段**：D · 数据建模师
> **关联 R-ID**：R-XXX, R-XXX
> **上游**：本 feature C01 R 基线、F01 03-database、F02 04-user-data-model、本 feature C04 原型 + C05 PRD、D-<feature-id>-questions-resolved
> **冻结状态**：未冻结
...
```markdown
<!-- TARGET-PATH: docs/C06-data/<feature-id>/01-er-diagram.md -->
...
```markdown
<!-- TARGET-PATH: docs/C06-data/<feature-id>/02-entities/<entity>.md -->
...
```markdown
<!-- TARGET-PATH: docs/C06-data/<feature-id>/03-state-machines.md -->
...
```markdown
<!-- TARGET-PATH: docs/C06-data/<feature-id>/04-business-rules.md -->
...
```markdown
<!-- TARGET-PATH: docs/C06-data/<feature-id>/05-indexes.md -->
...
```markdown
<!-- TARGET-PATH: docs/C06-data/<feature-id>/06-volume-growth.md -->
...
```markdown
<!-- TARGET-PATH: docs/C06-data/<feature-id>/99-open-questions.md -->
