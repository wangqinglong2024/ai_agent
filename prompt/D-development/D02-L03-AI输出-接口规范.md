...
```
我已答完 L 澄清。请按 /prompt/D-development/D02-L03-AI输出-接口规范.md 多文件结构输出，
落盘到 docs/D02-api/<feature-id>/。
路径/响应/错误码必须遵守 B01 04-api-conventions。
...
> **阶段**：L · 接口设计师
> **关联 R-ID**：R-XXX
> **上游**：B01 04-api-conventions, B02, 本 feature C03 页面交互, D01 D-<feature-id>, L-<feature-id>-questions-resolved
