...
> **谁产出**：AI（产品经理）
> **何时产出**：用户回完 E 澄清清单后。
> **落盘**：`docs/S11-prd/` 下多个文件（见 `S00-04` 文档目录规划）
...
```
我已答完 E 澄清。请按 /prompt/S11-E03-AI输出-产品需求文档.md 的多文件结构输出，
落盘到 docs/S11-prd/ 下对应文件，并在 00-index.md 中索引。
单文件 ≤ 1200 行，超出按主题继续拆。
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/00-index.md -->

# 产品需求文档 · 索引

> **阶段**：E · 产品经理
> **上游依赖**：docs/S11-prd/_input/prd-context.md，以及 R / A / P / D / L / X / S / I / N / H / V 全部冻结产物
> **冻结状态**：未冻结
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/01-overview.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/02-glossary.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/03-personas.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/04-feature-catalog.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/05-user-journeys.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/06-page-specs/00-index.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/06-page-specs/<page-id>.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/07-business-rules.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/08-data-model-summary.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/09-api-summary.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/10-roles-permissions.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/11-design-summary.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/12-tech-stack-summary.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/13-known-issues.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/14-roadmap.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/15-changelog.md -->
...
```markdown
<!-- TARGET-PATH: docs/S11-prd/99-open-questions.md -->
