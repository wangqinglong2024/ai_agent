...
4. 不重定义 B02 04-user-data-model 中的认证表。
5. 仍存疑写到 99。
...
> **阶段**：D · 数据建模师
> **关联 R-ID**：R-XXX, R-XXX
> **上游**：本 feature C01 R 基线、本 feature C02 IA（重点 03-state-machines.md，提供状态枚举与转移）、B01 03-database、B02 04-user-data-model、本 feature C04 原型 + C05 PRD、D-<feature-id>-questions-resolved
> **冻结状态**：未冻结
